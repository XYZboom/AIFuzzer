...
/**
 * Generated from: [io.github.xyzboom.aiFuzzer.tree.generator.TreeBuilder.dataType]
 */
abstract class UirDataType : UirElement, UirPureAbstractElement {
    abstract var name: String
    abstract var bits: Int

    override fun <R, D> accept(visitor: UirVisitor<R, D>, data: D): R =
        visitor.visitDataType(this, data)

    @Suppress("UNCHECKED_CAST")
    override fun <E : UirElement, D> transform(transformer: UirTransformer<D>, data: D): E =
        transformer.transformDataType(this, data) as E
}
